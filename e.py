...
class checker:
	...
	def Facebook(sayco):
                ...
                url = 'https://m.facebook.com/login/identify/?ctx=recover&c=https%3A%2F%2Fm.facebook.com%2Flogin%2F%3Fnext%26ref%3Ddbl%26fl%26login_from_aymh%3D1%26refid%3D8&multiple_results=0&ars=facebook_login&from_login_screen=0&lwv=100&ref=dbl&_rdr '
...
def main():
	...
	if domin in [ str(line) for line in range(1,6) ]:
		...
		for line in emails:
			def true(email,site):
				open(f'فيسبوك 1.txt','a').write(f'{email}\n')
